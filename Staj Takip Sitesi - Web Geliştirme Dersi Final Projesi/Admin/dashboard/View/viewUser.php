...
<head>
  ...
  <title>Yönetici - Kullanıcı Görüntüleme</title>
...
<body class="">
  ...
  <div class="main-content">
    ...
    <div class="header pb-8 pt-5 pt-md-8" style="background-color: #0F203F; border-bottom: 4px solid #D4AF37;">
        <div class="container">
            <center><h1 class="new-font mb-3 text-white">Yeni Kullanıcıların Listesi <i style="color: #D4AF37;" class="fas fa-info-circle"></i></h1></center>
                ...
                <tbody>
                  ...
                  ?>
                          <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary" style="color: #fff;" href="../AddUser/addAdmin.php?add-admin=<?php echo $row[$i]['user_id'] ?>">Yönetici</a>
                                <a class="btn btn-sm btn-info" style="color: #fff;" href="../AddUser/addTeacher.php?add-teacher=<?php echo $row[$i]['user_id'] ?>">Öğretmen</a>
                                <a class="btn btn-sm btn-default" style="color: #fff;" href="../AddUser/addStudent.php?add-student=<?php echo $row[$i]['user_id'] ?>">Öğrenci</a>
                            </td>
                        </tr>
                  <?php } ?>
                </tbody>
