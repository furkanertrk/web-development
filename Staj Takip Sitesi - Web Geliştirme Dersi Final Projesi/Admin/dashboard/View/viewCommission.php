...
<head>
  ...
  <title>Yönetici - Komisyon Listesi</title>
...
<body class="">
  ...
  <div class="main-content">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                ...
                <div class="media-body ml-2 d-none d-lg-block"><span style="color:white ;" class="mb-0 text-sm  font-weight-bold"><?php echo isset($_SESSION['adminID']) ? $_SESSION['admin_fullName'] : 'User'; ?></span></div>
              </div>
            </a>
    ...
    <div class="header pb-8 pt-5 pt-md-8 bg-neu-dark" style="border-bottom: 4px solid #D4AF37;">
        <div class="container">
            <center><h1 class="new-font mb-5 text-white">Komisyon Listesi <i style="color: #D4AF37;" class="fas fa-info-circle"></i></h1></center>
            ...
            <table class="table table-striped table-hover align-items-center">
                ...
                <?php 
                      ...
                      $row =  $teachers->viewAllCommission();
                      if(count($row)==0){
                        echo '<tr><td colspan="5" class="text-center">Komisyon Üyesi Bulunamadı!</td></tr>';
                      }else{
                      for($i = 0; $i<count($row); $i++){ 
                  ?>
                          <tr>
                            <th scope="row"><?php echo $i+1 ?></th>
                            <td><?php echo $row[$i]['ogretmen_ad_soyad'] ?></td>
                            <td><?php echo $row[$i]['ogretmen_okul_no'] ?></td>
                            <td><?php echo $row[$i]['ogretmen_bolum_adi'] ?></td>
                            <td>
                              <button class="btn btn-primary"><a style="color:#fff ;" href="../Info/commissionInfo.php?view-commission=<?php echo $row[$i]['ogretmen_id']  ?>">Görüntüle</a></button>
                            </td>
                          </tr>
                <?php } } ?>
                </tbody>
