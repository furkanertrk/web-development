...
<head>
  ...
  <title>Yönetici - Öğretmen Listesi</title>
...
<body class="">
  ...
  <div class="main-content">
    ...
    <div class="header pb-8 pt-5 pt-md-8" style="background-color: #0F203F; border-bottom: 4px solid #D4AF37;">
        <div class="container">
            <center><h1 class="new-font mb-5 text-white">Öğretmen Listesi <i style="color: #D4AF37;" class="fas fa-info-circle"></i></h1></center>
            ...
            <table class="table table-striped table-hover align-items-center">
                ...
                <?php 
                      ...
                      if(count($row)==0){
                        echo '<tr><td colspan="5" class="text-center">Öğretmen Bulunamadı!</td></tr>';
                      }else{
                  ...
                  ?>
                          <tr>
                            ...
                            <td>
                              <a class="btn btn-sm btn-primary" style="color:#fff;" href="../Info/TeacherInfo.php?view-teacher=<?php echo $row[$i]['ogretmen_id']  ?>">Görüntüle</a>
                            </td>
                          </tr>
                <?php } } ?>
                </tbody>
