...
<head>
  ...
  <title>Yönetici - Öğrenci Listesi</title>
...
<body class="">
  ...
  <div class="main-content">
    ...
    <div class="header pb-8 pt-5 pt-md-8" style="background-color: #0F203F; border-bottom: 4px solid #D4AF37;">
        <div class="container">
            <center><h1 class="new-font mb-3 text-white">Öğrenci Listesi <i style="color: #D4AF37;" class="fas fa-info-circle"></i></h1></center>
            ...
            <table class="table table-striped table-hover align-items-center">
                ...
                <?php 
                      ...
                      if(count($row)==0){
                        echo '<tr><td colspan="4" class="text-center">Öğrenci Bulunamadı!</td></tr>';
                      }else{
                      for($i = 0; $i<count($row); $i++){ 
                  ?>
                          <tr>
                            <th scope="row"><?php echo $i+1 ?></th>
                            <td><?php echo $row[$i]['ogrenci_ad_soyad'] ?></td>
                            <td><?php echo $row[$i]['ogrenci_okul_no'] ?></td>
                            <td>
                              <a class="btn btn-sm btn-primary" style="color:#fff;" href="../Info/StudentInfo.php?view-student=<?php echo $row[$i]['kullanci_id']  ?>">Görüntüle</a>
                            </td>
                          </tr>
                <?php } } ?>
                </tbody>
