...
<head>
  ...
  <title>Yönetici - Yönetici Ekleme</title>
...
<body class="">
  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--7">
        <center>
          <h1 class="new-font mb-4">Yönetici Ekleme Paneli <i style="color: green;" class="fas fa-info-circle"></i></h1>
        </center>
        <div class="order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form method="post" action="add_admin_post.php">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control form-control-alternative" name="fullName" placeholder="Ad Soyad" value="<?php echo $fullName; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Mail Adresi</label>
                        <input type="email" id="input-email" class="form-control form-control-alternative" name="email" placeholder="Mail Adresi" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Parola</label>
                        <input type="password" id="input-email" class="form-control form-control-alternative" name="password" placeholder="Parola" value="<?php echo $password; ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                        <button class="btn btn-primary" value="<?php echo $new_user_id ?>" type="submit" name="add-admin-btn">Yönetici Ekle</button>
                    </div>
                  </div>
                </div>
              </form>
