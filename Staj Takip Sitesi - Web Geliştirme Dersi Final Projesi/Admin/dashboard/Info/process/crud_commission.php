<?php
if(isset($_POST['remove_from_commission'])){

    $teacher_id =  $_POST['remove_from_commission'];
    ...
    header('Location: ../../View/viewCommission.php?role-update=success');
    exit();
}
...
if(isset($_POST['update_teacher_info'])){
    ...
    require '../../Backend/Teacher/update_teacher.php';
    $update_teacher_info = new UpdateTeacher($fullName, $tc, $email, $phone_number, $university_no, $password, $faculty, $department, $role, $teacher_id);
    header('Location: ../../View/viewCommission.php?update=success');
    exit();
}
...
if(isset($_POST['remove_teacher'])){
    ...
    header('Location: ../../View/viewCommission.php?commission-remove=success');
    exit();
}
?>