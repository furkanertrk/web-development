                ...
                */
                if(isset($_SESSION['studentID'])){
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        $new_sql = "INSERT into staj_kabul_belgesi(staj_turu, ogrenci_numarasi, ogrenci_staj_kabul_belgesi) VALUES('staj1', '$student_number', '$fileNameNew')";
                ...
                */
                if(isset($_SESSION['studentID'])){
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        $student_number = $row['ogrenci_okul_no'];
                        $ssql = "DELETE FROM staj_kabul_belgesi WHERE ogrenci_numarasi='$student_number'";
            ...
            if($fileSize1 > 5000 and $fileSize2 > 5000){
                ...
                if(isset($_SESSION['studentID'])){
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        $student_number = $row['ogrenci_okul_no'];
                        $new_sql = "INSERT into staj_belgeleri(staj_turu, ogrenci_numarasi, staj_raporu, staj_degerlendirme_formu) VALUES('staj1', '$student_number', '$fileNameNew1','$fileNameNew2')";
                        mysqli_query($connection, $new_sql);
                        $_SESSION['upload_file_error'] = 'Your file successfully uploaded!';
                        header('location: staj1-takibi.php?upload=success');
                        exit();
