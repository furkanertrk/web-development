...
<head>
  ...
  <title>Öğrenci - Staj 2 Takibi</title>
  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--5">
      <div class="card shadow">
        <div class="container">
              <center><h2 class="new-font mt-4 mb-3">Staj 2 Takibi Paneli <i style="color: green;" class="fas fa-info-circle"></i></h2></center>
              <?php
                  ...
                  while($row=mysqli_fetch_assoc($result)){
                    ...
                    $query = "SELECT * FROM staj_takibi WHERE ogrenci_numarasi='$student_number' AND staj_tur='staj2'";
                    ...
                    <?php
                      ...
                      ?>
                            ...
                            <div class="upload-file">
                                ...
                                <form action="internship2_uploads.php" method="POST" enctype="multipart/form-data">
                      ...
                      ?>
                          <div class="done">
                            ...
                            <h3 class="mt-2 mb-3 new-font"><b><?php echo $student_number ?></b> nolu öğrenci staj 2'yi başarıyla tamamlamıştır!</h3>
                            <?php echo '<p style="color:green;"><i class="fas fa-bell"></i> '.$row['geri_bildirim'].'</p>' ?>
                            ...
                            <div class="upload-file">
                                <?php
                                    if(isset($_SESSION['upload_file_error'])){
                                        ...
                                        echo '<h3 class="alert new-font">Staj 2 sürecini bitirmek için staj raporunuzu sisteme yükleyin!</h3>';
                                        echo '<p style="color:green;"><i class="fas fa-bell"></i> '.$row['geri_bildirim'].'</p>';
                                    }
                                ?>
                                <form action="internship2_uploads.php" method="POST" enctype="multipart/form-data">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    <?php 
                      $connection = mysqli_connect('localhost','root','','yazgeldb');
                      $sql = "SELECT * FROM staj_basvuru WHERE ogrenci_numarasi='$student_number' AND basvuru_turu='staj2'";
                      $result = mysqli_query($connection, $sql);
                    ...
                    <?php
                          $sql2 = "SELECT * FROM staj_takibi WHERE ogrenci_numarasi='$student_number' AND staj_tur='staj2'";
