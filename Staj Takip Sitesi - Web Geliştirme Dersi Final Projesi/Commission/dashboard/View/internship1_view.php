...
<head>
  ...
  <title>Komisyon - Staj 1 Öğrencileri</title>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">Staj 1 Öğrenci Listesi</h3>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                    <?php
                        ...
                        $sql = "SELECT ogrenci_numarasi FROM staj_basvuru WHERE basvuru_turu ='staj1'";
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary"><a style="color:#fff ;" href="view-internship1-student-info.php?view-student-info=<?php echo $new_row['kullanci_id'];?>">Görüntüle</a></button>
                                        </td>
                                    </tr>
                    <?php
                    $i++;
