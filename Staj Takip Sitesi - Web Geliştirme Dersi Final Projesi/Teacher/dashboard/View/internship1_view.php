...
<head>
  ...
  <title>Öğretmen - Staj 1 Öğrenci Listesi</title>
...
<body class="">
  ...
  <div class="main-content">
    ...
    <div class="header pb-4 pt-2 pt-lg-8 d-flex align-items-center" style="min-height: 200px; background-color: #0F203F; border-bottom: 4px solid #D4AF37;">
        <div class="container">
        <center><h1 class="new-font mb-4 text-white">Staj 1 Öğrenci Listesi <i style="color: #D4AF37;" class="fas fa-info-circle"></i></h1></center>
            ...
            <table class="table align-items-center table-flush">
                ...
                <tbody>
                    <?php
                        ...
                        $sql = "SELECT ogrenci_numarasi FROM staj_takibi WHERE staj_tur ='staj1' AND ogretmen_numarasi='$teacher_number'";
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="view-internship1-student-info.php?view-student-info=<?php echo $new_row['kullanci_id'];?>" class="btn btn-primary btn-sm">Görüntüle</a>
                                            <a href="staj1_notlandir.php?view-student-info=<?php echo $new_row['kullanci_id'];?>" class="btn btn-success btn-sm">Notlandır</a>
                                        </td>
                                    </tr>
                    <?php
                                }
